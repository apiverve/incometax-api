# Income Tax Brackets Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:incometax-api:1.1.14'
}
```
...
```java
import com.apiverve.incometax.IncomeTaxBracketsAPIClient;
import com.apiverve.incometax.APIResponse;
import com.apiverve.incometax.APIException;

// Initialize the client
IncomeTaxBracketsAPIClient client = new IncomeTaxBracketsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/incometax](https://docs.apiverve.com/ref/incometax)
...
- **Documentation:** [https://docs.apiverve.com/ref/incometax](https://docs.apiverve.com/ref/incometax)
- **Issues:** [GitHub Issues](https://github.com/apiverve/incometax-api/issues)
