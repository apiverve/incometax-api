...
/**
 * Client for the Income Tax Brackets API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/incometax?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/incometax';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IncometaxClient] {$message}\n";
        }
    }
}
