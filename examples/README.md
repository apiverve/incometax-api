# Income Tax Brackets API - Examples

This folder contains example code for using the Income Tax Brackets API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/incometax',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/incometax");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/incometax](https://docs.apiverve.com/ref/incometax)
