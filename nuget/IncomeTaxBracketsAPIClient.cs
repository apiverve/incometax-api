...
namespace APIVerve.API.IncomeTaxBrackets
{
    ...
    /// <summary>
    /// Client for the IncomeTaxBrackets API
    /// </summary>
    public class IncomeTaxBracketsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/incometax";
        ...
        public IncomeTaxBracketsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IncomeTaxBracketsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public IncomeTaxBracketsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, IncomeTaxBracketsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(IncomeTaxBracketsQueryOptions options)
        {
        ...
        public ResponseObj Execute(IncomeTaxBracketsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(IncomeTaxBracketsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(IncomeTaxBracketsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(IncomeTaxBracketsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(IncomeTaxBracketsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(IncomeTaxBracketsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(IncomeTaxBracketsQueryOptions options)
        {
